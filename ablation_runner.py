...
ABLATION_VARIANTS = {
    ...
    "full": {
        "desc": "Full model (L_CFM + L_reg + L_heading + L_calib + AUG-C + learned_weights)",
        "disable_l_heading": False,
        "disable_l_calib":   False,
        "disable_aug_c":     False,
        "disable_learned_weights": False,
        "disable_l_reg":     False,
        "n_inference_steps": 1,
    },
    # ── Loss ablations ─────────────────────────────────────────────────────
    "no_L_heading": {
        "desc": "Remove L_heading_ms (no heading constraint)",
        "disable_l_heading": True,
        "disable_l_calib":   False,
        "disable_aug_c":     False,
        "disable_learned_weights": False,
        "disable_l_reg":     False,
    ...
    "no_L_calib": {
        "desc": "Remove L_calib (no speed calibration training)",
        "disable_l_heading": False,
        "disable_l_calib":   True,
        "disable_aug_c":     False,
        "disable_learned_weights": False,
        "disable_l_reg":     False,
        "n_inference_steps": 1,
    ...
    "no_L_reg": {
        "desc": "Remove L_reg (no ADE auxiliary loss)",
        "disable_l_heading": False,
        "disable_l_calib":   False,
        "disable_aug_c":     False,
        "disable_learned_weights": False,
    ...
    "no_aug_c": {
        "desc": "Remove AUG-C recurvature augmentation",
        "disable_l_heading": False,
        "disable_l_calib":   False,
        "disable_aug_c":     True,
        "disable_learned_weights": False,
    ...
    "no_learned_weights": {
        "desc": "Fixed lambda weights (no Kendall, no learnable step weights)",
        "disable_l_heading": False,
        "disable_l_calib":   False,
        "disable_aug_c":     False,
        "disable_learned_weights": True,
        "disable_l_reg":     False,
        "n_inference_steps": 1,
    },
